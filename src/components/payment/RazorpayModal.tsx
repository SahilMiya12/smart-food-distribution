...
import { CreditCard, Loader2, CheckCircle, ShieldCheck, Heart, Sparkles } from "lucide-react";
    ...
    try {
      ...
      const options = {
        ...
        prefill: {
          ...
          contact: orderData.user?.phone || "9876543210",
        },
        theme: {
          color: "#059669",
        },
        handler: async function (response: any) {
          ...
          try {
            ...
            setError("Server error confirming payment verification.");
          } finally {
            setLoading(false);
          }
        },
      ...
      // If placeholder test key is used, fallback to seamless test simulator
      if (keyId === "rzp_test_YourRazorpayKeyHere" || keyId.includes("YourRazorpayKeyHere")) {
        // Direct simulation for local test key
        setTimeout(async () => {
