  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-black text-slate-900">Volunteer Notifications</h1>
          <p className="text-slate-500">Stay updated on available pickups and delivery tasks.</p>
        </div>
