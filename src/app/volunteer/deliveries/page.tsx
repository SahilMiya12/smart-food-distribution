        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {filteredList.map((item) => {
            ...
            return (
              <div
                key={item.id}
                className="flex flex-col justify-between overflow-hidden rounded-3xl border border-slate-200 bg-white p-6 shadow-sm transition hover:shadow-md space-y-4"
              >
                <div>
                  {donation.imageUrl && (
